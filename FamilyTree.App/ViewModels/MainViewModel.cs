...
public partial class MainViewModel : ObservableObject, IDisposable
{
    ...
    /// <summary>
    /// Редагує особу з РЯДКА списку родичів (батьки, діти) — ту, чию кнопку натиснули, а не
    /// виділену. Виділення при цьому не змінюється: користувач правив батька, а не переходив
    /// до нього, тож ані список, ані корінь дерева зсуватися не мають.
    /// </summary>
    [RelayCommand]
    private void EditRelative(Person? person)
    {
