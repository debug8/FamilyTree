...
public class StepFamilyTests
{
    ...
    public void Half_sibling_via_unknown_gender_parent_is_nepovnorodnyi()
    {
        ...
        Person("Спільний батько", Gender.Unknown);
        Person("Спільна матиА", Gender.Female);
        Person("Спільна матиБ", Gender.Female);
        Person("СинА", Gender.Male);
        Person("СинБ", Gender.Male);
        Parent("Спільний батько", "СинА");
        Parent("Спільна матиА", "СинА");
        Parent("Спільний батько", "СинБ");
        Parent("Спільна матиБ", "СинБ");
